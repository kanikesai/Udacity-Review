                ...
                t.exports = function() {
                    for (var e = !1, t = !1, i = /.*\/analytics\.js\/v1\/([^/]*)(\/platform)?\/analytics.*/, a = n.document.getElementsByTagName("script"), r = 0; r < a.length; r++) {
                        ...
                        if (u) {
                            e = !0;
                            var l = u[1];
                            if ("toT8LUD8hh9KKz18k1i8l8AnAJlF27VY" === l) {
                                t = !0;
                                break
                            }
                        }
                        ...
                        var d = {
                            ...
                            c = {
                                ...
                                properties: {
                                    ...
                                    loadedKey: "toT8LUD8hh9KKz18k1i8l8AnAJlF27VY",
                                    requestedKey: l,
        ...
        3: [function(e, t, n) {
            (function(t) {
                ...
                if (!e("./bot")()) {
                    ...
                    o._VERSIONS = {
                        "core": "4.1.8",
                        "cdn": "ajs-renderer 2.9.3 (analytics.js-private 2786acafccd96f458b63a9594ccbe6f5d86f8737)",
                        "integrations": {
                            "Blueshift": "2.0.0",
                            "Segment.io": "4.4.6"
                        }
                    ...
                    var l, d = {
                        ...
                        "Segment.io": {
                            "apiKey": "toT8LUD8hh9KKz18k1i8l8AnAJlF27VY",
                            "unbundledIntegrations": [],
                            "addBundledMetadata": true,
                            "maybeBundledConfigIds": {
                                "Optimizely X": ["5bedf9b2a66291000140912f"],
                                "Amazon Kinesis Firehose": ["5d2415d3753d9000019ba18f"],
                                "Blueshift": ["5f0ded1a0869747f69e800a5"]
                            },
                            "apiHost": "sgmt.udacity.com/api/v1",
                            "retryQueue": false
                        }
                    };
        ...
        243: [function(e, t, n) {;
            ...
            function o(e) {
                return a(function(e, t, n) {
                    null !== t && t !== undefined && (e[n] = t);
                    return e
                }, {}, e)
            }
            var i = e("@segment/analytics.js-integration"),
                a = e("@ndhoule/foldl"),
                r = t.exports = i("Blueshift").global("blueshift").global("_blueshiftid").option("apiKey", "").option("retarget", !1).tag('<script src="https://cdn.getblueshift.com/blueshift.js">');
            r.prototype.initialize = function() {
                window.blueshift = window.blueshift || [];
                window.blueshift.load = function(e) {
                    window._blueshiftid = e;
                    for (var t = ["identify", "track", "click", "pageload", "capture", "retarget"], n = 0; n < t.length; n++) blueshift[t[n]] = function(e) {
                        return function() {
                            blueshift.push([e].concat(Array.prototype.slice.call(arguments, 0)))
                        }
                    }(t[n])
                };
            ...
            r.prototype.page = function(e) {
                this.options.retarget && window.blueshift.retarget();
                var t = e.properties();
                t._bsft_source = "segment.com";
                t.customer_id = this.analytics.user().id();
                t.anonymousId = this.analytics.user().anonymousId();
                t.category = e.category();
                t.name = e.name();
                window.blueshift.pageload(o(t))
            };
            var s = {
                created: "created_at",
                firstName: "firstname",
            ...
            r.prototype.identify = function(e) {
                if (!e.userId() && !e.anonymousId()) return this.debug("user id required");
                var t = e.traits(s);
                t._bsft_source = "segment.com";
                t.customer_id = e.userId();
                t.anonymousId = e.anonymousId();
                window.blueshift.identify(o(t))
            };
            r.prototype.track = function(e) {
                ...
                t.customer_id = this.analytics.user().id();
                t.anonymousId = this.analytics.user().anonymousId();
                window.blueshift.track(e.event(), o(t))
            };
            r.prototype.alias = function(e) {
                window.blueshift.track("alias", o({
                    _bsft_source: "segment.com",
                    customer_id: e.userId(),
                    previous_customer_id: e.previousId(),
